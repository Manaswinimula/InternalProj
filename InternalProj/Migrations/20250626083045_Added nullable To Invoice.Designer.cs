...
namespace InternalProj.Migrations
{
    ...
    [Migration("20250626083045_Added nullable To Invoice")]
    partial class AddednullableToInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InternalProj.Models.Invoice", b =>
                {
                    ...
                    b.HasIndex("ModeOfPaymentModeId");
            ...
            modelBuilder.Entity("InternalProj.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("InternalProj.Models.ModeOfPayment", "ModeOfPayment")
                        .WithMany()
                        .HasForeignKey("ModeOfPaymentModeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InternalProj.Models.StaffReg", b =>
                {
                    ...
                    b.HasOne("InternalProj.Models.DeptMaster", "DeptMaster")
                        .WithMany("StaffRegs")
                        .HasForeignKey("DeptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InternalProj.Models.DesignationMaster", "DesignationMaster")
                        .WithMany("StaffRegs")
